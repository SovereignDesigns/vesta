(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[2004], {
        ...
        t.default = function(e, t) {
            ...
            return function() {
                for (var a = [], l = 0; l < arguments.length; l++)
                    a[l] = arguments[l];
                return i && r === this && t(a, o) || (n = e.apply(this, a),
                i = !0,
                r = this,
                o = a),
                n
    ...
    60722: function(e, t, r) {
        var n, a = Object.create, o = Object.defineProperty, i = Object.getOwnPropertyDescriptor, l = Object.getOwnPropertyNames, s = Object.getPrototypeOf, u = Object.prototype.hasOwnProperty, c = (e,t,r,n)=>{
            if (t && "object" === typeof t || "function" === typeof t)
                for (let a of l(t))
                    u.call(e, a) || a === r || o(e, a, {
                        get: ()=>t[a],
                        enumerable: !(n = i(t, a)) || n.enumerable
                    });
            return e
        }
        , d = (e,t,r)=>(r = null != e ? a(s(e)) : {},
        c(!t && e && e.__esModule ? r : o(r, "default", {
            value: e,
            enumerable: !0
        }), e)), p = (e,t,r)=>(((e,t,r)=>{
            t in e ? o(e, t, {
        ...
        class P extends h.Component {
                ...
                p(this, "progress", (()=>{
                    if (this.props.url && this.player && this.isReady) {
                        ...
                        if (r) {
                            ...
                            null !== t && (n.loadedSeconds = t,
                            n.loaded = t / r),
                            n.playedSeconds === this.prevPlayed && n.loadedSeconds === this.prevLoaded || this.props.onProgress(n),
            ...
            componentDidUpdate(e) {
                ...
                f.default)(e.url, t)) {
                    ...
                    b.isMediaStream)(t))
                        return console.warn(`ReactPlayer: the attempt to load ${t} is being deferred until the player has loaded`),
                        void (this.loadOnReady = t);
                    this.isLoading = !0,
                    this.startOnPlay = !0,
                ...
                e.muted !== a && (a ? this.player.mute() : (this.player.unmute(),
                null !== n && setTimeout((()=>this.player.setVolume(n))))),
                e.playbackRate !== o && this.player.setPlaybackRate && this.player.setPlaybackRate(o),
            ...
            seekTo(e, t, r) {
                if (!this.isReady)
                    return void (0 !== e && (this.seekOnPlay = e,
                    setTimeout((()=>{
                        this.seekOnPlay = null
                    }
                    ), 5e3)));
            ...
            render() {
                ...
                return e ? h.default.createElement(e, {
                    ...this.props,
        ...
        p(P, "displayName", "Player"),
        p(P, "propTypes", m.propTypes),
        p(P, "defaultProps", m.defaultProps)
    },
    70390: function(e, t, r) {
        ...
        var h = d(r(67294))
          ...
          , w = d(r(60722));
        const v = (0,
        g.lazy)((()=>r.e(7664).then(r.t.bind(r, 83855, 23))))
          , O = "undefined" !== typeof window && window.document && "undefined" !== typeof document
          , k = "undefined" !== typeof r.g && r.g.window && r.g.window.document
            ...
            return r = class extends h.Component {
                constructor() {
                    ...
                    p(this, "renderActivePlayer", (e=>{
                        ...
                        return h.default.createElement(w.default, {
                            ...this.props,
                            key: t.key,
    ...
    22004: function(e, t, r) {
        ...
        var f = (0,
        y.createReactPlayer)(p.default, h)
    },
    71776: function(e, t, r) {
        var n, a = Object.defineProperty, o = Object.getOwnPropertyDescriptor, i = Object.getOwnPropertyNames, l = Object.prototype.hasOwnProperty, s = {};
        ((e,t)=>{
            for (var r in t)
                a(e, r, {
                    get: t[r],
        ...
        const c = /(?:youtu\.be\/|youtube(?:-nocookie|education)?\.com\/(?:embed\/|v\/|watch\/|watch\?v=|watch\?.+&v=|shorts\/|live\/))((\w|-){11})|youtube\.com\/playlist\?list=|youtube\.com\/user\//
          ...
          , C = e=>{
            ...
            return !(!(0,
            u.isMediaStream)(e) && !(0,
            u.isBlobUrl)(e)) || (_.test(e) || T.test(e) || j.test(e) || E.test(e) || S.test(e))
        }
          , I = {
            youtube: e=>e instanceof Array ? e.every((e=>c.test(e))) : c.test(e),
            soundcloud: e=>d.test(e) && !_.test(e),
            vimeo: e=>p.test(e) && !T.test(e) && !j.test(e),
            mux: e=>y.test(e),
            facebook: e=>h.test(e) || f.test(e),
            streamable: e=>m.test(e),
            wistia: e=>b.test(e),
            twitch: e=>P.test(e) || g.test(e),
            dailymotion: e=>w.test(e),
            mixcloud: e=>v.test(e),
            vidyard: e=>O.test(e),
            kaltura: e=>k.test(e),
            file: C
    ...
    86497: function(e, t, r) {
        Object.create;
        var n, a = Object.defineProperty, o = Object.getOwnPropertyDescriptor, i = Object.getOwnPropertyNames, l = (Object.getPrototypeOf,
        Object.prototype.hasOwnProperty), s = (e,t,r,n)=>{
            if (t && "object" === typeof t || "function" === typeof t)
                for (let s of i(t))
                    l.call(e, s) || s === r || a(e, s, {
                        get: ()=>t[s],
        ...
        var c = r(38045)
          ...
          , p = [{
            ...
            lazyPlayer: (0,
            c.lazy)((()=>r.e(4439).then(r.t.bind(r, 60356, 23))))
        }, {
            key: "soundcloud",
            name: "SoundCloud",
            canPlay: d.canPlay.soundcloud,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(6125).then(r.t.bind(r, 72648, 23))))
        }, {
            key: "vimeo",
            name: "Vimeo",
            canPlay: d.canPlay.vimeo,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(3743).then(r.t.bind(r, 80868, 23))))
        }, {
            key: "mux",
            name: "Mux",
            canPlay: d.canPlay.mux,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(4258).then(r.t.bind(r, 58376, 23))))
        }, {
            key: "facebook",
            name: "Facebook",
            canPlay: d.canPlay.facebook,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(2121).then(r.t.bind(r, 31972, 23))))
        }, {
            key: "streamable",
            name: "Streamable",
            canPlay: d.canPlay.streamable,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(2546).then(r.t.bind(r, 50993, 23))))
        }, {
            key: "wistia",
            name: "Wistia",
            canPlay: d.canPlay.wistia,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(8055).then(r.t.bind(r, 8018, 23))))
        }, {
            key: "twitch",
            name: "Twitch",
            canPlay: d.canPlay.twitch,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(6216).then(r.t.bind(r, 29482, 23))))
        }, {
            key: "dailymotion",
            name: "DailyMotion",
            canPlay: d.canPlay.dailymotion,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(7596).then(r.t.bind(r, 36807, 23))))
        }, {
            key: "mixcloud",
            name: "Mixcloud",
            canPlay: d.canPlay.mixcloud,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(4667).then(r.t.bind(r, 50143, 23))))
        }, {
            key: "vidyard",
            name: "Vidyard",
            canPlay: d.canPlay.vidyard,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(8888).then(r.t.bind(r, 36596, 23))))
        }, {
            key: "kaltura",
            name: "Kaltura",
            canPlay: d.canPlay.kaltura,
            lazyPlayer: (0,
            c.lazy)((()=>r.e(261).then(r.t.bind(r, 73911, 23))))
        }, {
            key: "file",
            name: "FilePlayer",
            canPlay: d.canPlay.file,
            canEnablePIP: e=>d.canPlay.file(e) && (document.pictureInPictureEnabled || (0,
            c.supportsWebKitPresentationMode)()) && !d.AUDIO_EXTENSIONS.test(e),
            lazyPlayer: (0,
            c.lazy)((()=>r.e(6011).then(r.t.bind(r, 14926, 23))))
        }]
    },
    ...
    38045: function(e, t, r) {
        ...
        ((e,t)=>{
            ...
            queryString: ()=>T,
            randomString: ()=>_,
            supportsWebKitPresentationMode: ()=>L
        }),
        e.exports = (n = p,
        c(o({}, "__esModule", {
            value: !0
        ...
        var y = d(r(67294))
          , h = d(r(49090))
          , f = d(r(9996));
        const m = e=>y.default.lazy((async()=>{
            const t = await e();
            ...
            if (r) {
                ...
                if (e.match(g))
                    return function(e) {
                        ...
                        for (; null !== r; ) {
                            const [,n,a] = r;
                            "h" === a && (t += 60 * parseInt(n, 10) * 60),
                            "m" === a && (t += 60 * parseInt(n, 10)),
                            "s" === a && (t += parseInt(n, 10)),
                            r = g.exec(e)
                        }
                        return t
